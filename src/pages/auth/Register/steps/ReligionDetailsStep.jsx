...
//   const [anyCaste, setAnyCaste] = useState(false);
...
//           >
//             <span className={religion ? "text-gray-800" : "text-gray-400"}>
...
//             >
//               <span>
//                 {anyCaste ? "Any caste" : caste || "Select caste"}
//               </span>
//               <span className="text-gray-400">›</span>
//             </button>
//           </div>
...
//         <button
//           onClick={handleNext}
//           disabled={!religion || (!anyCaste && !caste)}
//           className={`w-full py-4 rounded-xl font-semibold text-base
//             ${
//               religion && (anyCaste || caste)
