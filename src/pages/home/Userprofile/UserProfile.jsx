...
//             lifestyle: {
//               // backend currently sends full text in lifestyle; we don't have IDs yet,
//               // so we start with empty arrays and let user set new ones
//               music_genre_ids: [],
//               reading_preference_ids: [],
//               drinking: resp.lifestyle?.drinking || "",
...
//     // convenience: shallow path updates for this simple form
...
//       // update local data with fresh response if returned in same shape
...
//                 <div className="flex items-center gap-2">
//                   <FiBriefcase className="w-3 h-3 text-primary" />
//                   <p className="text-gray-700">
...
//                 <div className="flex items-center gap-2">
//                   <FiBookOpen className="w-3 h-3 text-primary" />
//                   <p className="text-gray-700">
...
//                     onClick={handleSave}
//                     disabled={saving}
//                     className="mt-2 w-full bg-primary text-white py-2.5 rounded-full text-[12px] font-semibold shadow disabled:opacity-60"
//                   >
                ...
                <div className="flex items-start gap-2">
                  ...
                  <div>
                    <p className="text-[10px] font-semibold text-gray-700 mb-0.5">
                      About : <span className="text-red-500 ml-1">{profile.user.name}</span>
                    </p>
                    {editing ? (
        <textarea
              ...
              <section className="bg-white rounded-3xl shadow-sm border border-gray-100 p-4 text-[11px] space-y-2">
                ...
                <div className="space-y-1.5">
                  ...
                  <LabeledInput
                    label="Degree"
                    value={
                      editing ? form.course_degree : profile.course_degree || ""
                    }
                    onChange={(v) =>
                  ...
                  <LabeledInput
                    label="College"
                    value={editing ? form.college : profile.college || ""}
                  ...
                  <LabeledInput
                    label="Passing Year"
                    value={
                      editing ? form.passing_year : profile.passing_year || ""
                    }
